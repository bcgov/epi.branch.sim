...
```
Run `?draw_contact_rate` for more information on the above choices. All contact rates are given with respect to the non-distancing group, which has a contact rate of 1.
